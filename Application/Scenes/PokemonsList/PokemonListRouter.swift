...
final class PokemonListRouter: PokemonListDataPassing {
    ...
    weak var pokemonFavoriteFactory: PokemonListFavoritesFactory!
...
extension PokemonListRouter: PokemonListRoutingLogic {
    ...
    func routeToFavorites() {
        let destinationVC = pokemonFavoriteFactory.makePokemonFavoritesViewController() as! PokemonFavoritesViewController
           navigateToDetailPokemon(source: viewController, destination: destinationVC)
       }
